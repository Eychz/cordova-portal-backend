...
router.get('/slug/:slug', postController_1.postController.getPostBySlug);
...
router.patch('/:id', auth_1.authenticateToken, (0, auth_1.authorizeRole)('admin', 'official'), postController_1.postController.updatePost);
